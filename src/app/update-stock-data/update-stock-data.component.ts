...
@Component({
  selector: 'app-update-stock-data',
  templateUrl: './update-stock-data.component.html',
  styleUrls: ['./update-stock-data.component.css']
})
export class UpdateStockDataComponent implements OnInit {
  @Input("data") data;
