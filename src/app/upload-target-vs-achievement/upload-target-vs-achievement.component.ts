...
@Component({
  selector: "app-upload-target-vs-achievement",
  templateUrl: "./upload-target-vs-achievement.component.html",
  styleUrls: ["./upload-target-vs-achievement.component.scss"],
  providers: [
...
export class UploadTargetVsAchievementComponent  implements OnInit {
