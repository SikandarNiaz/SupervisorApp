...
@Component({
  selector: 'app-kt-attendance-evaluation',
  templateUrl: './kt-attendance-evaluation.component.html',
  styleUrls: ['./kt-attendance-evaluation.component.scss'],
})
export class KtAttendanceEvaluation implements OnInit {
  ...
  getData() {
    ...
    this.httpService.getKTAttendanceEvaluation(obj).subscribe(
      (data) => {
