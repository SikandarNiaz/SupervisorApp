import {
  ...
  @Component({
    selector: 'app-update-kt-supervisor-attendance-CGS.component',
    templateUrl: './update-kt-supervisor-attendance-CGS.component.html',
    styleUrls: ['./update-kt-supervisor-attendance-CGS.component.scss']
  })
  export class UpdateKTSupervisorAttendenceCGSComponent implements OnInit {
