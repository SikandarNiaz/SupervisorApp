...
@Component({
  selector: "app-census-router-tracker",
  templateUrl: "./census-router-tracker-component.html",
styleUrls: ["./census-router-tracker-component.scss"],

})
export class CensusRouteTrackerComponent implements OnInit {
