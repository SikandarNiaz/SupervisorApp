...
@Component({
  selector: "app-transmed-router-tracker",
  templateUrl: "./transmed-router-tracker.component.html",
  styleUrls: ["./transmed-router-tracker.component.scss"],
})
export class TransmedRouteTrackerComponent implements OnInit {
